...
set_background_image(r"C:\Users\DELL\PycharmProjects\campus_x_NLP_PROJECT\5607654.jpg")
...
def set_custom_styles():
    st.markdown(
        ...
        div.stButton > button {
            background-color: #FF80ED !important;  /* Pinkish button */
            color: #000000 !important;             /* Dark indigo text */
            border: none !important;
        }
        /* Button hover effect */
        div.stButton > button:hover {
            background-color: #D87093 !important;  /* Darker pink on hover */
